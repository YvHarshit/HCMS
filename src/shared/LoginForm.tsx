  ...
  return (
    <div className="w-max rounded-xl border border-gray-200 bg-white px-8 py-10 shadow-sm">
      ...
      <div className="mb-7 flex h-[2.1rem] rounded-lg bg-gray-100 p-1">
        <button
          type="button"
          className="flex-1 rounded-md bg-white text-md font-medium text-blue-600 shadow-sm"
        >
          Login
        </button>
        ...
        <button
          type="button"
          className="flex-1 rounded-md text-md font-medium text-gray-600 hover:text-gray-900"
        >
          Create Account
        </button>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div>
          <label
            htmlFor="email"
            className="mb-2 block text-lg text-gray-800 mx-2"
          >
            Email address
          </label>
